...
import { updateQuoteAction } from "@/lib/actions/quote-actions";
...
export function QuoteEditForm({
  ...
  const [state, action, pending] = useActionState(updateQuoteAction, undefined);
